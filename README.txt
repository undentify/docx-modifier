...
2. Для работы необходим установленный python 3.9 (на других 3.x тоже должно работать, но не проверялось), также необходим pip (кк правило устанавливается вместе с python)
